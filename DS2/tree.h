...
{
	TreeItem *head;
    vector<TreeItem*> Searches;
    vector<TreeItem*> SearchesFinal;
...
public:
    ...
    vector <string> LocateFinal (string qry);
    ...
    void countFiles(TreeItem* temp, int& count);
